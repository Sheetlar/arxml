...
from autosar.model.swc_implementation import SwcImplementation
from autosar.model.ar_object import ArObject
from autosar.model.base import InvalidPortInterfaceRef, split_ref, InvalidPortRef, InvalidMappingRef
from autosar.model.element import Element
from autosar.model.port import Port, ProvidePort, RequirePort
from autosar.model.portinterface import SenderReceiverInterface

if TYPE_CHECKING:
    from autosar import Template
    from autosar.model.behavior import InternalBehaviorCommon
